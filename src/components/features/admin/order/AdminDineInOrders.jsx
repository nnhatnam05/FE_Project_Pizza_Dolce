...
import "./Order.css";
import { FaSync, FaSearch, FaUser, FaTable, FaEye, FaFilter, FaCalendarAlt, FaUtensils, FaDollarSign, FaClock } from "react-icons/fa";
...
export default function AdminDineInOrders() {
  ...
  const fetchOrders = async (showLoading = true) => {
    ...
    try {
      const response = await axios.get("http://localhost:8080/api/admin/orders/dine-in", {
        headers: { Authorization: `Bearer ${token}` }
      });
      setOrders(response.data);
    } catch (error) {
      console.error("Failed to fetch dine-in orders:", error);
      showError("Failed to fetch dine-in orders");
    } finally {
  ...
  const getStatusColor = (status) => {
    const statusObj = DINE_IN_STATUS.find(s => s.key === status);
      ...
      <div className="modern-filters">
        ...
        <div className="search-group">
          <div className="search-input-wrapper">
            ...
            <input
              type="text"
              placeholder="Search orders, customers, staff, tables..."
              value={searchTerm}
                  ...
                  >
                    ...
                    <div className="order-card-body">
                      ...
                      <div className="order-info-row">
                        ...
                        <span>Customer: {order.customer?.fullName || 'Walk-in'}</span>
                      </div>
          ...
          <div className="details-section">
            {selectedOrder ? (
                ...
                <div className="details-content">
                  <div className="detail-section">
                    ...
                    <div className="detail-grid">
                      ...
                      <div className="detail-item">
                        <label>Table:</label>
                        <span>{selectedOrder.table?.name || 'N/A'}</span>
                      </div>
                      <div className="detail-item">
                  ...
                  <div className="detail-section">
                    ...
                    <div className="detail-grid">
                      <div className="detail-item">
                        <label>Name:</label>
                        <span>{selectedOrder.customer?.fullName || 'Walk-in Customer'}</span>
                      </div>
              ...
              <div className="no-selection">
                <FaUtensils className="no-selection-icon" />
